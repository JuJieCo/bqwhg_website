...
<form name="form1" method="post" action="${pageContext.request.contextPath}/indexAction!queryWxshMenu" id="form1">
...
<div class="main3_content">
	<div class="w936">
		<dl class="qwdt2">
			<dt>  <img src="${pageContext.request.contextPath}/${list.hold}"  alt="" width="196" height="111"  onerror=" ${list.wxshType eq 0 ? "this.src='resource/images/list13.jpg'":"this.src='resource/images/list12.png'" }" /> </dt>
				<dd class="qwdt_bt2"> <a href="${pageContext.request.contextPath}/indexAction!findWxshForShow?wxshID=${list.wxshID}">${list.wxshTitle}</a><span class="date">${list.subDate}</span></dd>
                <dd class="qwdt_nr2"> ${fn:substring (list.wxshContent , 0, 39)}...   <a href="${pageContext.request.contextPath}/indexAction!findWxshForShow?wxshID=${list.wxshID}">[全文]</a> </dd>
         </dl>
	</div>
</div>    
