...
<form name="form1" method="post" action="${pageContext.request.contextPath}/indexAction!queryQwzcMenu" id="form1">
...
<div class="main3_content">
	<div class="w936">
		<dl class="qwdt2">
			<dt>  <img src="${pageContext.request.contextPath}/resource/images/4.jpg"  alt="" width="196" height="111" /> </dt>
				<dd class="qwdt_bt2"> <a href="${pageContext.request.contextPath}/indexAction!findQwzcForShow?qwzcID=${list.qwzcID}">${list.qwzcTitle}</a><span class="date">${list.subDate}</span></dd>
                <dd class="qwdt_nr2"> ${fn:substring (list.qwzcContent , 0, 39)}...   <a href="${pageContext.request.contextPath}/indexAction!findQwzcForShow?qwzcID=${list.qwzcID}">[全文]</a> </dd>
         </dl>
	</div>
</div>    
