...
<form name="form1" method="post" action="${pageContext.request.contextPath}/indexAction!queryFyzsMenu" id="form1">
...
<div class="main3_content">
	<div class="w936">
		<dl class="qwdt2">
			<dt>  <img src="${pageContext.request.contextPath}/${list.hold}"  alt="" width="196" height="111"  onerror="this.src='resource/images/list12.png'" /> </dt>
				<dd class="qwdt_bt2"> <a href="${pageContext.request.contextPath}/indexAction!findFyzsForShow?fyzsID=${list.fyzsID}">${list.fyzsTitle}</a><span class="date">${list.subDate}</span></dd>
                <dd class="qwdt_nr2"> ${fn:substring (list.fyzsContent , 0, 39)}...   <a href="${pageContext.request.contextPath}/indexAction!findFyzsForShow?fyzsID=${list.fyzsID}">[全文]</a> </dd>
         </dl>
	</div>
</div>    
