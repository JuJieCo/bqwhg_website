...
<form name="form1" method="post" action="${pageContext.request.contextPath}/indexAction!queryGbkwMenu" id="form1">
...
<div class="main3_content">
	<div class="w936">
		<dl class="qwdt2">
			<dt>  <img src="${pageContext.request.contextPath}/resource/images/2.jpg"  alt="" width="196" height="111" /> </dt>
				<dd class="qwdt_bt2"> <a href="${pageContext.request.contextPath}/indexAction!findGbkwForShow?gbkwID=${list.gbkwID}">${list.gbkwTitle}</a><span class="date">${list.subDate}</span></dd>
                <dd class="qwdt_nr2"> ${fn:substring (list.gbkwContent , 0, 39)}...   <a href="${pageContext.request.contextPath}/indexAction!findGbkwForShow?gbkwID=${list.gbkwID}">[全文]</a> </dd>
         </dl>
	</div>
</div>    
