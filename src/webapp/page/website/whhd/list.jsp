...
<form name="form1" method="post" action="${pageContext.request.contextPath}/indexAction!queryWhhdMenu" id="form1">
	...
	<div class="w936">
		<dl class="qwdt2">
			<dt>  <img src="${pageContext.request.contextPath}/${list.hold}"  alt="" width="196" height="111"   onerror="this.src='resource/images/list12.png'" /> </dt>
				<dd class="qwdt_bt2"> <a href="${pageContext.request.contextPath}/indexAction!findWhhdForShow?whhdID=${list.whhdID}">${list.whhdTitle}</a><span class="date">${list.subDate}</span></dd>
                <dd class="qwdt_nr2"> ${fn:substring (list.whhdContent , 0, 39)}...   <a href="${pageContext.request.contextPath}/indexAction!findWhhdForShow?whhdID=${list.whhdID}">[全文]</a> </dd>
         </dl>
	</div>
</div>    
