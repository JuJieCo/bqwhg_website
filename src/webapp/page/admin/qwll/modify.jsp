...
<script type="text/javascript">	
  	function validateForm(){
  		var qwllTitle = document.getElementById('qwllTitle').value;
...
<BODY>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		<TR height=28>
			<TD background="${pageContext.request.contextPath}/resource/admin/images/title_bg1.jpg">&nbsp;西安市灞桥区文化馆网站后台管理系统--群文理论</TD>
		</TR>
		<TR>
...
<form action="${pageContext.request.contextPath}/qwllAction!modifyQwll" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="qwll.qwllID" type="hidden" value="${qwll.qwllID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="qwll.qwllTitle" value="${qwll.qwllTitle }" size="50" id="qwllTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="qwll.subDate"  value="<fmt:formatDate value="${qwll.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="qwll.sysUser.loginName" value="${qwll.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="qwll.sysUser.userID" value="${qwll.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="qwll.qwllContent">${qwll.qwllContent }</textarea> 
