...
<script type="text/javascript">	
  	function validateForm(){
  		var whhdTitle = document.getElementById('whhdTitle').value;
...
<BODY>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		<TR height=28>
			<TD background="${pageContext.request.contextPath}/resource/admin/images/title_bg1.jpg">&nbsp;西安市灞桥区文化馆网站后台管理系统--文化活动</TD>
		</TR>
		<TR>
...
<form action="${pageContext.request.contextPath}/whhdAction!modifyWhhd" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="whhd.whhdID" type="hidden" value="${whhd.whhdID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="whhd.whhdTitle" value="${whhd.whhdTitle }" size="50" id="whhdTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="whhd.subDate"  value="<fmt:formatDate value="${whhd.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="whhd.sysUser.loginName" value="${whhd.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="whhd.sysUser.userID" value="${whhd.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="whhd.whhdContent">${whhd.whhdContent }</textarea> 
