...
<script type="text/javascript">	
  	function validateForm(){
  		var qwzcTitle = document.getElementById('qwzcTitle').value;
...
<BODY>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		<TR height=28>
			<TD background="${pageContext.request.contextPath}/resource/admin/images/title_bg1.jpg">&nbsp;西安市灞桥区文化馆网站后台管理系统--群文政策</TD>
		</TR>
		<TR>
...
<form action="${pageContext.request.contextPath}/qwzcAction!modifyQwzc" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="qwzc.qwzcID" type="hidden" value="${qwzc.qwzcID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="qwzc.qwzcTitle" value="${qwzc.qwzcTitle }" size="50" id="qwzcTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="qwzc.subDate"  value="<fmt:formatDate value="${qwzc.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="qwzc.sysUser.loginName" value="${qwzc.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="qwzc.sysUser.userID" value="${qwzc.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="qwzc.qwzcContent">${qwzc.qwzcContent }</textarea> 
