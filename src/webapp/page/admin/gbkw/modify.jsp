...
<script type="text/javascript">	
  	function validateForm(){
  		var gbkwTitle = document.getElementById('gbkwTitle').value;
...
<BODY>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		<TR height=28>
			<TD background="${pageContext.request.contextPath}/resource/admin/images/title_bg1.jpg">&nbsp;西安市灞桥区文化馆网站后台管理系统--馆办刊物</TD>
		</TR>
		<TR>
...
<form action="${pageContext.request.contextPath}/gbkwAction!modifyGbkw" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="gbkw.gbkwID" type="hidden" value="${gbkw.gbkwID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="gbkw.gbkwTitle" value="${gbkw.gbkwTitle }" size="50" id="gbkwTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="gbkw.subDate"  value="<fmt:formatDate value="${gbkw.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="gbkw.sysUser.loginName" value="${gbkw.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="gbkw.sysUser.userID" value="${gbkw.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="gbkw.gbkwContent">${gbkw.gbkwContent }</textarea> 
