...
<script type="text/javascript">	
  	function validateForm(){
  		var jbgkTitle = document.getElementById('jbgkTitle').value;
...
<BODY>
	<TABLE cellSpacing=0 cellPadding=0 width="100%" align=center border=0>
		<TR height=28>
			<TD background="${pageContext.request.contextPath}/resource/admin/images/title_bg1.jpg">&nbsp;西安市灞桥区文化馆网站后台管理系统--基本概况</TD>
		</TR>
		<TR>
...
<form action="${pageContext.request.contextPath}/jbgkAction!modifyJbgk" id="form1" name="form1" method="post"  enctype="multipart/form-data" onsubmit="return validateForm();" >
...
<table width="100%"  border="0" cellspacing="0" cellpadding="0" >
  ...
  <tr>
    ...
    <input name="jbgk.jbgkID" type="hidden" value="${jbgk.jbgkID }">
	<table width="100%" border="0" cellspacing="0" cellpadding="0">
	  <tr>
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="b5d6e6" onmouseover="changeto()"  onmouseout="changeback()">
          <tr>
			...
			<td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3"> &nbsp;&nbsp;<input type="text" name="jbgk.jbgkTitle" value="${jbgk.jbgkTitle }" size="50" id="jbgkTitle"></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="jbgk.subDate"  value="<fmt:formatDate value="${jbgk.subDate }" pattern="yyyy-M-d"/>" readonly="readonly" ></td>
          ...
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;<input type="text" name="jbgk.sysUser.loginName" value="${jbgk.sysUser.loginName}"   readonly="readonly"  id="loginName">
            																																						   <input type="hidden" name="jbgk.sysUser.userID" value="${jbgk.sysUser.userID }">
            </td>     	
          </tr>
          <tr>
            ...
            <td height="22" align="left" bgcolor="#FFFFFF" class="STYLE3" width="85%"  colspan="3">&nbsp;&nbsp;
            	    <textarea id="id_1" name="jbgk.jbgkContent">${jbgk.jbgkContent }</textarea> 
